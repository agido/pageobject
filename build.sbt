...
lazy val core = (project in file("core"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.seleniumhq.selenium" % "selenium-java" % "3.0.1" exclude("com.codeborne", "phantomjsdriver"),
      "org.seleniumhq.selenium" % "htmlunit-driver" % "2.23.2" % Optional,
      "net.sourceforge.htmlunit" % "htmlunit" % "2.23" % Optional exclude("org.eclipse.jetty.websocket", "websocket-client"),
